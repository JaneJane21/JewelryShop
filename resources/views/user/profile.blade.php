...
<div class="container" id="Profile">
    <h2 class="mt-5">Профиль пользователя</h2>
    <div class="row mt-3" style="box-shadow: 0 0 20px rgba(0,0,0,.1); background-color: rgb(231, 231, 233); padding: 25px; border-radius: 10px;">
        <div class="col-7">
            ...
            <div class="row">
                ...
                <div class="col-auto">
                    <a href="{{ route('user_profile_destroy') }}" class="btn btn-outline-danger">удалить профиль</a>
                </div>
            </div>
        </div>
    </div>
    ...
    const app={
      ...
      methods:{
        async Reg(){
          ...
          const response = await fetch('{{ route('user_profile_edit') }}',{
            method:'post',
            headers:{
